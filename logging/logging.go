...
func (instance *Logging) GetInstanceLog(request cloudprotocol.RequestLog) (err error) {
...
func (instance *Logging) GetInstanceCrashLog(request cloudprotocol.RequestLog) (err error) {
